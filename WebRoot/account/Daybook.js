$(function() {
	...
	$('#direction').select2({
		ajax : {
			url : basePath + '/sys/dictQuery',
			dataType : 'json',
			delay : 200,
			data : function(params) {
				return {
					param : 'moneydirection'
				};
			},
	...
	var dt = $('#datatable').DataTable({
		...
		columns : [
			...
			{ data : 'oper', title : '操作', orderable : false, render : function(data, type, full, meta) {
				return '<div class="tbtools"><i class="fa fa-edit" onclick="void(0);"></i>&nbsp;&nbsp;&nbsp;<i class="fa fa-trash-o"></i></div>';
			} } ],
		ajax : {
